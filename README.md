...
| --- | --- | --- |
| [AMBA VIP](https://github.com/quang-tran0/amba-vip) | Reusable UVM 1.2 master VIPs and self-checking environments for APB and AHB-Lite; AXI is planned as **Future Work**. | SystemVerilog / UVM / APB / AHB-Lite |
